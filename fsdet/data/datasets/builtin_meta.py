...
#     1: ['Hole', 'Fold', 'Black', 'Crake'],
#     2: ['Hole', 'Fold', 'Black', 'Crake'],
#     3: ['Hole', 'Fold', 'Black', 'Crake'],
# }
...
# 焊缝 5 3
PASCAL_VOC_ALL_CATEGORIES = {
    1: ['air-hole', 'bite-edge', 'broken-arc', 'crack', 'hollow-bead', 'overlap',
               'slag-inclusion', 'unfused'],
    2: ['air-hole', 'bite-edge', 'broken-arc', 'crack', 'hollow-bead', 'overlap',
               'slag-inclusion', 'unfused'],
    3: ['air-hole', 'bite-edge', 'broken-arc', 'crack', 'hollow-bead', 'overlap',
               'slag-inclusion', 'unfused'],
}
...
# # 钢铁 3 3 
# PASCAL_VOC_ALL_CATEGORIES = {
#     1: ['crazing', 'inclusion', 'patches', 'pitted_surface', 'rolled-in_scale', 'scratches'],
#     2: ['crazing', 'inclusion', 'patches', 'pitted_surface', 'rolled-in_scale', 'scratches'],
#     3: ['crazing', 'inclusion', 'patches', 'pitted_surface', 'rolled-in_scale', 'scratches'],
# }
